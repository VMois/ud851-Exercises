...
public class MainActivity extends AppCompatActivity {
    ...
    // DONE - TODO (1) Create a method called showMap with a Uri as the single parameter
    // Do steps 2 - 4 within the showMap method
        // DONE - TODO (2) Create an Intent with action type, Intent.ACTION_VIEW

        // DONE - TODO (3) Set the data of the Intent to the Uri passed into this method
