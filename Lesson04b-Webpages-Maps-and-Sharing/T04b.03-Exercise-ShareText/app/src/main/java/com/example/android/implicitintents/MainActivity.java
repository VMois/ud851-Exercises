...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        // DONE - TODO (5) Specify a String you'd like to share
        String text = "Learn Java and Android";
        Log.d("ShareText", "WORK");
        // DONE - TODO (6) Replace the Toast with shareText, passing in the String from step 5
        shareText(text);
    ...
    public void shareText(String text) {
        ...
        String title = "How to rule the world?";
        ShareCompat.IntentBuilder.from(this)
                .setChooserTitle(title)
                .setType(mimeType)
                .setText(text);
    }
    // DONE - TODO (1) Create a void method called shareText that accepts a String as a parameter
    // Do steps 2 - 4 within the shareText method

        // DONE - TODO (2) Create a String variable called mimeType and set it to "text/plain"

        // DONE - TODO (3) Create a title for the chooser window that will pop up

        // DONE - TODO (4) Use ShareCompat.IntentBuilder to build the Intent and start the chooser
}